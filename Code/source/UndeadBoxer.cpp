...
UndeadBoxer::~UndeadBoxer(void) {

}

void UndeadBoxer::Update(float elapsedTime){
...
void UndeadBoxer::Render(){
	...
	SGD::GraphicsManager::GetInstance()->DrawTextureSection(
		m_hImage,
		this->GetPosition(),
		{ ((float)(this->GetDirection()) * 96.0f) - 32.0f, 32.0f, ((float)(this->GetDirection()) * 96.0f), 64.0f },
		0.0f,
		{},
		SGD::Color(255, 255, 255),
...
SGD::Rectangle	UndeadBoxer::GetRect() const{

	return Enemies::GetRect();
}

void UndeadBoxer::HandleCollision(const IEntity* pOther){
